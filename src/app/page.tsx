    ...
    <main className="relative w-full overflow-hidden text-white">
      ...
      <section className="w-full bg-[#FAEBDD] py-16 px-6 md:px-12 text-[#1E1E1E]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <h3 className="text-2xl md:text-3xl font-serif mb-4 md:mb-0">
            See What We’re Whisking Up
          </h3>
          <a
        ...
        >
          {doubledImages.map((src, i) => (
            <img
              ...
              src={src}
              alt={`carousel-${i}`}
              className="rounded-3xl w-64 md:w-72 h-80 object-cover flex-shrink-0 hover:scale-105 transition-transform duration-300 pointer-events-none"
              loading="lazy"
            />
          ))}
        </div>
